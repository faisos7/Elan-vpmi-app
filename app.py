...
def init_session_state():
    ...
    if 'patient_db' not in st.session_state:
        ...
        items = [
            ...
            {"제품": "커드", "용량": "150ml", "수량": 7}, # [v.4.8] 커드 추가 완료
            {"제품": "EX", "용량": "280ml", "수량": 3},
        ...
        items = [
            ...
            {"제품": "인삼대사체(PAGI) 항암용", "용량": "50ml", "수량": 14} # [v.4.8] PAGI -> 인삼대사체(PAGI) 항암용 통일
        ]
        ...
        items = [
            ...
            {"제품": "커드 시원한 것", "용량": "280ml", "수량": 14},
            {"제품": "인삼대사체(PAGI) 항암용", "용량": "50ml", "수량": 14} # [v.4.8] PAGI 희석액 -> 인삼대사체(PAGI) 항암용 통일
        ]
